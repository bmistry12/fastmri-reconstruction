...
from torch.optim import RMSprop, Adam, SGD, ASGD, Adagrad
...
if __name__ == '__main__':       
    ...
    optimizer = Adagrad(model.parameters(), learning_rate, weight_decay=weight_decay)
...
plt.xlabel('epoch')
plt.legend()
plt.savefig('loss-4f-' + str(epochs) + 'adagrad.png')
# plt.show()
